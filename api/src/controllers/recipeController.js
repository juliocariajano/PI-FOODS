...
const getInfoApi = async ()=>{
    const apiEndPoint = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=6166256ad4ea4527a5f55b433d7d5de7&addRecipeInformation=true&number=100`)
